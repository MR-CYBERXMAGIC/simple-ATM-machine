...
async function Withdraw() {
    const amount = await inquirer.prompt({
        name: "selection",
        type: "list",
        message: chalk.cyan.bold.italic("Please select the amount you want to withdraw"),
        choices: [
            chalk.yellow(500),
            chalk.yellow(1000),
            chalk.yellow(2000),
...
async function amountAdder(amountEntered) {
